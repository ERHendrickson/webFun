//Using the monster variable below how could we access the name?
//Using the monster variable below how could we access the 2nd type?
...
//     for (let j = 0; j < pokémon[i].types.length; j++) {
//         // console.log(pokémon[i].types[j])
